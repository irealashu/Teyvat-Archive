...
export const SPECIAL_CHARACTERS: Character[] = [
  ...
  },
  {
    ...
    rarity: 5,
    region: 'Other',
    affiliation: 'Traveler / Adventurers\' Guild',
    birthday: 'Player\'s Choice',
    constellationName: 'Viator / Viatrix',
    description: 'A traveler from another world whose twin was taken by an unknown god, embarking on an epic journey across Teyvat to master the elements and find their kin.',
